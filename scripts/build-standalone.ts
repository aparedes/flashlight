...
type AssetGroup = "profiler" | "report" | "webapp";
interface Asset {
  group: AssetGroup;
  name: string;
  sourcePath: string;
...
for (const group of ["profiler", "report", "webapp"] as const) {
...
export const EMBEDDED_ASSETS: { group: "profiler" | "report" | "webapp"; name: string; path: string }[] = [
${entries}
];
`;
