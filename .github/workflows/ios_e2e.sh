...
mkdir -p report
bun packages/platforms/ios-instruments/dist/launchIOS.js ios-test --appId $APPID --simulatorId $UDID --testCommand 'maestro test ./packages/platforms/ios-instruments/test.yaml' --resultsFilePath './report/result.json'